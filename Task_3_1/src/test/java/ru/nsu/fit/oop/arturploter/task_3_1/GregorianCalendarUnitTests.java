...
class GregorianCalendarUnitTests {
    private final GregorianDate date = new GregorianDate(17, 12, 2019);
    private GregorianCalendar calendar;

    @BeforeEach
    void setCalendar() {
        calendar = new GregorianCalendar(date);
    }

    @Test
    void addDaysAndGetDate1() {
        calendar.addDays(14);
        assertEquals(new GregorianDate(31, 12, 2019), calendar.getDate());
    }

    @Test
    void addDaysAndGetDate2() {
        calendar.addDays(1624);
        assertEquals(new GregorianDate(28, 5, 2024), calendar.getDate());
    }

    @Test
    void addDaysAndGetDate3() {
        calendar.addDays(13555);
        assertEquals(new GregorianDate(26, 1, 2057), calendar.getDate());
    }
    ...
    void subtractDaysAndGetDate1() {
        ...
        assertEquals(new GregorianDate(6, 12, 2019), calendar.getDate());
    }

    @Test
    void subtractDaysAndGetDate2() {
        calendar.subtractDays(243);
        assertEquals(new GregorianDate(18, 4, 2019), calendar.getDate());
    }

    @Test
    void subtractDaysAndGetDate3() {
        calendar.subtractDays(13555);
        assertEquals(new GregorianDate(6, 11, 1982), calendar.getDate());
    }
    ...
    void getDateInXDays1() {
        assertEquals(new GregorianDate(28, 12, 2019), calendar.getDateInXDays(11));
    }

    @Test
    void getDateInXDays2() {
        assertEquals(new GregorianDate(21, 7, 2023), calendar.getDateInXDays(1312));
    }

    @Test
    void getDateInXDays3() {
        assertEquals(new GregorianDate(20, 10, 2059), calendar.getDateInXDays(14552));
    }
    ...
    void getDayOfTheWeekIWasBornGetDateOfBirthAndSetDateOfBirth1() {
        calendar.setDateOfBirth(new GregorianDate(4, 2, 2000));
        assertEquals(new GregorianDate(4, 2, 2000), calendar.getDateOfBirth());
        assertEquals(5, calendar.getDayOfTheWeekIWasBorn());
    }

    @Test
    void getDayOfTheWeekIWasBornGetDateOfBirthAndSetDateOfBirth2() {
        calendar.setDateOfBirth(new GregorianDate(3, 12, 1925));
        assertEquals(new GregorianDate(3, 12, 1925), calendar.getDateOfBirth());
    ...
    void setDateOfBirth_IncorrectDateOfBirth_IllegalArgumentExceptionThrown1() {
        Exception exception = assertThrows(IllegalArgumentException.class,
                () -> calendar.setDateOfBirth(new GregorianDate(2, 12, 1900)));
    ...
    void setDateOfBirth_IncorrectDateOfBirth_IllegalArgumentExceptionThrown2() {
        Exception exception = assertThrows(IllegalArgumentException.class,
                () -> calendar.setDateOfBirth(new GregorianDate(2, 12, 2020)));
        assertEquals("Invalid date.", exception.getMessage());
    }
    ...
    void getYearsMonthsDaysPassedSince1() {
        assertEquals(new DateDifference(74, 7, 8),
                calendar.getYearsMonthsDaysPassedSince(new GregorianDate(9, 5, 1945)));
    }

    @Test
    void getYearsMonthsDaysPassedSince2() {
        assertEquals(new DateDifference(3, 1, 5),
                calendar.getYearsMonthsDaysPassedSince(new GregorianDate(12, 11, 2016)));
    }

    @Test
    void getYearsMonthsDaysPassedSince3() {
        assertEquals(new DateDifference(1, 11, 20),
                calendar.getYearsMonthsDaysPassedSince(new GregorianDate(27, 12, 2017)));
    }
    ...
    void getYearsMonthsDaysPassedSince5() {
        calendar = new GregorianCalendar(new GregorianDate(5, 1, 2010));

        assertEquals(new DateDifference(9, 0, 27),
                calendar.getYearsMonthsDaysPassedSince(new GregorianDate(9, 12, 2000)));
    }

    @Test
    void getYearsMonthsDaysPassedSince_DateIsGreaterOrEqualToTheDateSetInTheCalendar_IllegalArgumentExceptionThrown() {
        Exception exception = assertThrows(IllegalArgumentException.class,
                () -> calendar.getYearsMonthsDaysPassedSince(new GregorianDate(9, 12, 2020)));
    ...
    void getNextFridayThe13th1() {
        assertEquals(new GregorianDate(13, 3, 2020), calendar.getNextFridayThe13th());
    }

    @Test
    void getNextFridayThe13th2() {
        calendar = new GregorianCalendar(new GregorianDate(1, 5, 2019));
        assertEquals(new GregorianDate(13, 9, 2019), calendar.getNextFridayThe13th());
    }

    @Test
    void getNextFridayThe13th3() {
        calendar = new GregorianCalendar(new GregorianDate(11, 11, 2019));
        assertEquals(new GregorianDate(13, 12, 2019), calendar.getNextFridayThe13th());
    }

    @Test
    void getNextFridayThe13th4() {
        calendar = new GregorianCalendar(new GregorianDate(11, 12, 2020));
        assertEquals(new GregorianDate(13, 8, 2021), calendar.getNextFridayThe13th());
    }
}