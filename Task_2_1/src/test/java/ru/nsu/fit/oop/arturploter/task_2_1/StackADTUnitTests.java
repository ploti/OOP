...
public class StackADTUnitTests {
    ...
    @Test
    public void throwsNoSuchElementExceptionIfThePopMethodWasCalledOnTheEmptyStack() {
        StackADT<Integer> stack = new StackADT<>();
    ...
    @Test
    public void throwsNoSuchElementExceptionIfTheNextMethodWasCalledOnTheEmptyStack() {
